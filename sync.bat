...
set "src=E:\wangzhan"
set "dst=E:\Github\wangzhan"

echo [1] 开始同步文件...
echo.

echo [2] 复制 admin.html...
copy /Y "%src%\admin.html" "%dst%\admin.html"
if errorlevel 1 (
...
copy /Y "%src%\tools-upload.html" "%dst%\tools-upload.html"
if errorlevel 1 (
...
copy /Y "%src%\projects-upload.html" "%dst%\projects-upload.html"
if errorlevel 1 (
...
copy /Y "%src%\css\style.css" "%dst%\css\style.css"
if errorlevel 1 (
...
copy /Y "%src%\js\main.js" "%dst%\js\main.js"
if errorlevel 1 (
...
copy /Y "%src%\images\hero.jpg" "%dst%\images\hero.jpg"
if errorlevel 1 (
...
copy /Y "%src%\images\profile.jpg" "%dst%\images\profile.jpg"
if errorlevel 1 (
